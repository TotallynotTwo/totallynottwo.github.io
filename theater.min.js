try {
    ...
    function work(){
        ...
        document.body.innerHTML = "erros2rr: " + err
    }
}
    ...
    var theater = {
        ...
        volume: 25,
        syncMaxDiff: 5,
        getPlayerContainer: async function () {
            if (document.getElementsByTagName("video").length) {
                if (document.getElementsByTagName("video")[0].canPlayType) {
                    console.log("vid")
                    res = "video"
  ...
  /*          try{
                ...
                var checkExist = setInterval(async function () {
                  try{  
                    if (document.getElementsByTagName("video").length > 0 || document.getElementsByTagName("iframe").length > 0 && Boolean(document.getElementsByTagName("iframe")[0].allowFullscreen)) {
              ...
              resolve(document.getElementsByTagName(res)[0])
            }
...
try{
                        ...
                        vol = document.getElementsByTagName(res)[0]
                        vol.volume = a
                    }catch(err){
                        document.body.innerHTML = "errorr2: " + err
                    }
                    }
                }, 100)
                ...
                // this.volume = a, null !== this.player && this.player.setVolume(a)
                   ...
                   document.body.innerHTML = "errorr: " + err
            }
        },
        seek: function (a) {
    ...
    DefaultVideo.prototype = {
        ...
        lastStartTime: 0,
        startTime: 0,
        setVolume: function (a) { document.body.innerHTML = "ok" },
        ...
        function () {
            ...
            var b = function () {
                ...
                this.froogaloop = null, this.setVideo = function (a) {
                    ...
                    d.setAttribute("id", "player1"), d.setAttribute("src", c), d.setAttribute("width", "100%"), d.setAttribute("height", "100%"), d.setAttribute("frameborder", "0"), document.getElementsByTagName("video")[0].appendChild(d), $f(d).addEvent("ready", this.onReady)
                }, this.setVolume = function (a) {
                    document.body.innerHTML = "55"
            ...
            var c = function () {
                ...
                this.videoInfo = {}, this.embed = function () {
                    ...
                    this.player = document.getElementsByTagName("video")[0], this.interval = setInterval(function () {
                        a.think(a)
                    }, 100)
            ...
            var f = function () {
                ...
                this.embed = function () {
                    ...
                    b.setAttribute("id", "player1"), b.setAttribute("src", this.videoId), b.setAttribute("width", "100%"), b.setAttribute("height", "100%"), b.setAttribute("frameborder", "0"), document.getElementsByTagName("video")[0].appendChild(b)
                }, this.setVideo = function (b) {
                    if (this.lastVideoId = null, this.videoId = b, null === this.player) {
                        this.lastVideoId = this.videoId, this.embed();
                        var c = 0,
            ...
            var h = function () {
                this.embed = function () {
                    ...
                    b.setAttribute("id", "player1"), b.style.width = "100%", b.style.height = "100%", b.innerHTML = this.videoId, document.getElementsByTagName("video")[0].appendChild(b)
